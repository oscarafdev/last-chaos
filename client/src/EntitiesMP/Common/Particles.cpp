																	...
																	FLOAT fParam1, FLOAT fParam2, COLOR cColor)
{
	...
	for(INDEX i=0; i<ctCount; i++)
	{
		...
		//COLOR colCombined=(col&0xFFFFFF00)|ubA;
		COLOR colCombined=(col&cColor)|ubA;		//Color :Su-won
...
//(Modify Original Sam Effect)(0.1)
										...
										CTextureData *ptdRainMap, FLOATaabbox3D &boxRainMap)
{
	...
	// EnvironmentParticleHolder 'Particle Texture'
