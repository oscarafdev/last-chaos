...
ULONG_PTR WINAPI EmbedBrowserObject(HWND);
#define EMBEDBROWSEROBJECT EmbedBrowserObject
typedef ULONG_PTR WINAPI EmbedBrowserObjectPtr(HWND);
...
typedef ULONG_PTR WINAPI UnEmbedBrowserObjectPtr(HWND);
#define UNEMBEDBROWSEROBJECTNAME "UnEmbedBrowserObject"

#ifdef UNICODE
ULONG_PTR WINAPI DisplayHTMLPage(HWND, const WCHAR *);
typedef ULONG_PTR WINAPI DisplayHTMLPagePtr(HWND, const WCHAR *);
#else
ULONG_PTR WINAPI DisplayHTMLPage(HWND, const char *);
typedef ULONG_PTR WINAPI DisplayHTMLPagePtr(HWND, const char *);
#endif
#define DISPLAYHTMLPAGE DisplayHTMLPage
#define DISPLAYHTMLPAGENAME "DisplayHTMLPage"

#ifdef UNICODE
ULONG_PTR WINAPI DisplayHTMLStr(HWND, const WCHAR *);
typedef ULONG_PTR WINAPI DisplayHTMLStrPtr(HWND, const WCHAR *);
#else
ULONG_PTR WINAPI DisplayHTMLStr(HWND, const char *);
typedef ULONG_PTR WINAPI DisplayHTMLStrPtr(HWND, const char *);
#endif
