...
const char* GetDirectX12LegacyMaterial3DShader()
{
	return
		...
		"  }\n"
		"  if (mode == 2) {\n"
		// Las capas usan REPEAT, pero sus máscaras usan CLAMP en D3D9.
		// La firma raíz histórica comparte sampler; saturar las coordenadas
		// de máscara reproduce el direccionamiento correcto sin otro sampler.
		...
		"    float2 reflectionUV = input.texCoord1 + float2(\n"
