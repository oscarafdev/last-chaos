...
{
	int i, j;
	if (ch->m_pZone->m_index != ZONE_DUNGEON4  &&  ch->m_pZone->m_index != ZONE_CAPPELLA_1 && ch->m_pZone->m_index != ZONE_ALTER_OF_DARK && ch->m_pZone->m_index != ZONE_AKAN_TEMPLE && ch->m_pZone->m_index != ZONE_TARIAN_DUNGEON)
  {
